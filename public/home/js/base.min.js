...
function(e, t) {
    MI.message = {
        ...
        init: function(e) {
            ...
            t.initDelay), $(window).on("focus.loopMessage",
            function() {
                t.uid && (t.stopLoop(), t.getMessage())
            }).on("blur.loopMessage",
            function() {
                t.stopLoop()
            }))
        ...
        getMessage: function() {
            var e = this;
            e.loopCount > 0 && e.loopSpeed <= 30 && e.loopCount % 5 === 0 && (e.loopSpeed = 2 * e.loopSpeed),
            e.loopCount += 1,
            $.ajax({
                url: e.apiUrl + e.uid,
                dataType: "jsonp",
                ...
                error: function() {},
                success: function(t) {
                    t && 0 === t.code && (e.messageTotal = t.data.count, e.updateMessageNum(), 1 === t.data.loop ? (clearTimeout(e.loopTimer), e.loopTimer = setTimeout(function() {
                        e.getMessage()
                    },
