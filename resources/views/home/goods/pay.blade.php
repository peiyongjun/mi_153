...
<script type="text/javascript">
var _confirmConfig = {
    order_id:'1161013919700111',
    safe_tel:'',
    goods_amount:'1499.00'
};
</script>
...
<div class="modal fade modal-hide modal-pay-tip" id="J_payTip" aria-hidden="false">
    ...
    <div class="modal-body clearfix">
        <div class="success">
            <h4>支付成功了</h4>
            <p><a href="http://order.mi.com/user/orderView/1161013919700111">立即查看订单详情 &gt;</a></p>
        </div>
        <div class="fail">
            <h4>如果支付失败</h4>
...
<script src="//s01.mifile.cn/js/base.min.js?v2016d35"></script>
<script>
(function() {
